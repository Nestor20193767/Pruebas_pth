...
if gemini_key and uploaded_file:
    ...
    with text_box:
        if question:
            ...
            The user can ask you to change the language between spanish an english. If the user do it response frindly and after say teh comand: 
            "Change to language: (Language say by user)" an example is: Change to language: Spanish
            """
            ...
            with st.chat_message("assistant"):
                ...
                if "Change to language: Spanish" in response_text:
                    option_language == "Spanish"

                if "Change to language: English" in response_text:
                    option_language == "English"
